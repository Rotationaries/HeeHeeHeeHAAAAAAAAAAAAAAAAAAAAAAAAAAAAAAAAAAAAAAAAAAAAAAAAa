...
//   public CreatingPaths(Drivetrain drive) {
//     m_drive = drive;
...
//   AutoConstants.kMaxAccelerationMetersPerSecondSquared);
//   return Commands.sequence(driveCommand(traj));
...
//   RamseteCommand command = new RamseteCommand(traj, m_drive::getPose, new RamseteController(AutoConstants.kRamseteB, AutoConstants.kRamseteB), 
//     AutoConstants.feedforward, DriveConstants.kDriveKinematics, m_drive::getWheelSpeeds, 
//     xController,
//     yController, m_drive::tankDriveVolts, m_drive);
//     return command;
// }
